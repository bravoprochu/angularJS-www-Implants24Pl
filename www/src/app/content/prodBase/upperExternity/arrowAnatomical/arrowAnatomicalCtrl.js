(function () {
    ...
    angular
        .module('app')
        .controller('arrowAnatomicalCtrl', arrowAnatomicalCtrl);

    arrowAnatomicalCtrl.$inject = ['$state', 'commonFunctions'];

    function arrowAnatomicalCtrl($state, cF) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'arrowAnatomical';
