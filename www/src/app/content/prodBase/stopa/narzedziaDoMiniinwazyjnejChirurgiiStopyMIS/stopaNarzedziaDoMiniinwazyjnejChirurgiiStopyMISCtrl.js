(function () {
    ...
    angular
        .module('app')
        .controller('stopaNarzedziaDoMiniinwazyjnejChirurgiiStopyMISCtrl', stopaNarzedziaDoMiniinwazyjnejChirurgiiStopyMISCtrl);

    stopaNarzedziaDoMiniinwazyjnejChirurgiiStopyMISCtrl.$inject = ['$state', '$rootScope', 'commonFunctions', 'imagePreload', 'statesHelp'];

    function stopaNarzedziaDoMiniinwazyjnejChirurgiiStopyMISCtrl($state, $rootScope, cF, imagePreload, statesHelp) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'stopaNarzedziaDoMiniinwazyjnejChirurgiiStopyMIS';
