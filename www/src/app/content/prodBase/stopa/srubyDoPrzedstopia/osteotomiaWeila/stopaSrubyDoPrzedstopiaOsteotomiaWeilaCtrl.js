(function () {
    ...
    angular
        .module('app')
        .controller('stopaSrubyDoPrzedstopiaOsteotomiaWeilaCtrl', stopaSrubyDoPrzedstopiaOsteotomiaWeilaCtrl);

    stopaSrubyDoPrzedstopiaOsteotomiaWeilaCtrl.$inject = ['$state', '$rootScope', 'commonFunctions', 'imagePreload', 'statesHelp'];

    function stopaSrubyDoPrzedstopiaOsteotomiaWeilaCtrl($state, $rootScope, cF, imagePreload, statesHelp) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'stopaSrubyDoPrzedstopiaOsteotomiaWeila';
