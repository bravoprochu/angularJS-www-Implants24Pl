(function () {
    ...
    angular
        .module('app')
        .controller('stopaSrubyDoPrzedstopiaTechnikiOperacyjneCtrl', stopaSrubyDoPrzedstopiaTechnikiOperacyjneCtrl);

    stopaSrubyDoPrzedstopiaTechnikiOperacyjneCtrl.$inject = ['$state', '$rootScope', 'commonFunctions', 'imagePreload', 'statesHelp'];

    function stopaSrubyDoPrzedstopiaTechnikiOperacyjneCtrl($state, $rootScope, cF, imagePreload, statesHelp) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'stopaSrubyDoPrzedstopiaTechnikiOperacyjne';
