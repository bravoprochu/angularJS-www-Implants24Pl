(function () {
    ...
    angular
        .module('app')
        .controller('stopaCalcanailCtrl', stopaCalcanailCtrl);

    stopaCalcanailCtrl.$inject = ['$state', '$rootScope', 'commonFunctions', 'imagePreload', 'statesHelp'];

    function stopaCalcanailCtrl($state, $rootScope, cF, imagePreload, statesHelp) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'stopaCalcanail';
